...
export function AppSidebar() {
  ...
  const getNavCls = ({
    ...
    isActive: boolean;
  }) => isActive ? "bg-gradient-primary text-white font-medium shadow-glow" : "hover:bg-secondary/50 transition-all duration-200 text-white";
  ...
  return <Sidebar className={`${collapsed ? "w-16" : "w-64"} border-r border-border bg-gradient-dark`}>
      ...
      <SidebarFooter className="p-4">
        <Button onClick={handleLogout} variant="ghost" className="w-full justify-start text-white hover:bg-white/10 hover:text-white">
